...
void UnityConcludeTest(void)
{
    ...
    {
        Unity.TestIgnores++;
        // UnityIgnore already prints the full line, so we don't print it here
    }
    ...
    {
        Unity.TestFailures++;
        // Failing tests are handled by UnityFail, which already prints the full line
    }
...
void UnityFail(const char* msg, const UNITY_LINE_TYPE line)
{
    ...
    UNITY_OUTPUT_CHAR(':');
    UnityPrint(Unity.CurrentTestName);
    UnityAddMsgIfSpecified(msg); // This will add the message after the test name
...
void UnityIgnore(const char* msg, const UNITY_LINE_TYPE line)
{
    ...
    if (msg != NULL)
    {
        UnityPrint(" "); // Add a space before the message
        UnityPrint(msg);
    }
